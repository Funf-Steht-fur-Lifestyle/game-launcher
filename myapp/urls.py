...
urlpatterns = [
    ...
    path('game/saved', views.saved_games_page, name='saved_games_page'),
    path('game/saved/<int:saved_game_id>', views.saved_game_details_page, name='saved_game_details_page'),
